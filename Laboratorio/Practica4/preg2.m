...
%Tomando en cuenta los resultados obtenidos, puede asegurarse que la matriz
%C, es positivo definida, debido a que tiene descomposición cholesky,
%mientras que la matriz E, no tiene.
