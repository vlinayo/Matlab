...
[x1a]=jacobi(A,b(1:n,1),x0,tol,maxit);
%tiempo de jacobi
...
[x1b]=jacobi(A,b(1:n,1),x02,tol,maxit);
%tiempo de jacobi
...
[x3a]=gausseid(A,b(1:n,1),x0,tol,maxit);
...
[x3b]=gausseid(A,b(1:n,1),x02,tol,maxit);
%tiempo de Gauss-Seidel
...
%Con Jacobi la solucion para x03 seria:
    ...
    [y1a]=jacobi(A,b(1:n2,1),x03,tol,maxit);
    %tiempo de jacobi
...
%Con Jacobi la solucion para x04 seria:
    ...
    [y1b]=jacobi(A,b(1:n2,1),x04,tol,maxit);
    %tiempo de jacobi
...
%Con Gauss-Seidel la solucion para x03 seria:
    ...
    [y3a]=gausseid(A,b(1:n2,1),x03,tol,maxit);
    %tiempo de Gauss-Seidel
...
%Con Gauss-Seidel la solucion para x04 seria:
    ...
    [y3b]=gausseid(A,b(1:n2,1),x04,tol,maxit);
    %tiempo de Gauss-Seidel
